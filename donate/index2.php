...
<div id="donate-modal" class="modal open">
	<div class="overlay"> </div>
		
	<form action="https://docs.google.com/forms/d/1Kv6aEhZp55Gcdr4inVs6xVwlLZE3G7TA8Jj8hq5ob7I/formResponse" method="POST" id="shirts-form" target="_self" onsubmit=""><ol role="list" class="ss-question-list" style="padding-left: 0">
	<h2>Details</h2>
	...
	<div dir="ltr" class="ss-item ss-item-required ss-radio"><div class="ss-form-entry">
	<label class="ss-q-item-label" for="entry_930713389"><div class="form-title">Color:
	<label for="itemView.getDomIdToLabel()" aria-label="(Required field)"></label>
	</div>
	<div class="ss-q-help ss-secondary-text" dir="ltr"></div></label>
	
	<ul class="ss-choices" role="radiogroup" aria-label="Color:  "><li class="ss-choice-item"><label><input type="radio" name="entry.1301241003" value="White" id="group_1301241003_1" role="radio" class="ss-q-radio" aria-label="White" required="" aria-required="true">
	<span class="ss-choice-label">White</span>
	</label></li> <li class="ss-choice-item"><label><input type="radio" name="entry.1301241003" value="Red" id="group_1301241003_2" role="radio" class="ss-q-radio" aria-label="Red" required="" aria-required="true">
	<span class="ss-choice-label">Red</span>
	</label></li></ul>
	<div class="error-message" id="930713389_errorMessage"></div>
	</div></div></div> <div class="ss-form-question errorbox-good" role="listitem">
	...
	<input type="submit" name="submit" value="DONATE $20 VIA PAYPAL" id="ss-submit" class="jfk-button jfk-button-action donate-button">
	</td>
...
//	CHANGE BUTTON TEXT FOR SHIRT OR SWEATSHIRT
	$('#shirts-form li').click(function () {
		if ($("#shirts-form input[type='radio']:checked + .ss-choice-label").hasClass('hoodie')) {
			$('#shirts-form .donate-button').val("DONATE $35 VIA PAYPAL");
		}else {
			$('#shirts-form .donate-button').val("DONATE $20 via PAYPAL");
		}
	});
});
</script>		
