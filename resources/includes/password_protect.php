...
<html>
<head>
  <title>PayPal Media Network Login</title>
  <META HTTP-EQUIV="CACHE-CONTROL" CONTENT="NO-CACHE">
  <META HTTP-EQUIV="PRAGMA" CONTENT="NO-CACHE">
</head>
<body>
		<script type="text/javascript" src="/j/jquery-latest.min.js"></script>
		<script>
	$(document).ready(function(){
			...
			$("input.submit").click(function(){						// if user actually hits sumit btn
				$(".chatbox").val($("textarea").val());		// transfer value from textarea to hidden "chatbox"
				formsubmit();
			});
			function formsubmit(){
			$("#login").submit();	
	...
	* {margin:0; padding:0;}
	...
	.password_container textarea:focus {
		border:none;
...
<?php if (USE_USERNAME) echo 'Login:<br /><input type="input" name="access_login" /><br />Password:<br />'; ?>
	...
	<textarea onfocus="this.value=''; this.onfocus=null;">Password</textarea>
...
<div class="clr"></div>
<p class="nda">
	By entering, you agree to the <a href="/nda" target="_blank">Non-Disclosure Agreement.</a>
</p>
  </div>
</body>
</html>
